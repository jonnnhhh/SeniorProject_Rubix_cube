...
##Clock signal
set_property -dict { PACKAGE_PIN K17   IOSTANDARD LVCMOS33 } [get_ports { I_sys_clk_top }]; #IO_L12P_T1_MRCC_35 Sch=I_sys_clk_top
#create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { I_sys_clk_top }];
...
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { I_on_board_reset_n }]; #IO_L7P_T1_34 Sch=btn[3]


##LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { debug_led[0] }]; #IO_L23P_T3_35 Sch=led[0]
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { debug_led[1] }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { debug_led[2] }]; #IO_0_35 Sch=led[2]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { debug_led[3] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
...
##Pmod Header JC
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { I_rx_serial_data }]; #IO_L10P_T1_34 Sch=jc_p[1]
